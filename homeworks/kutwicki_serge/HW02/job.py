""" Homework 02 - Managing suites of the tests

    There are two numbers.
    Each of them can be negative, floating etc.
...
def main(runtime):
    ...
    parser.add_argument('-num1', required=False, type=float, default=1)
    parser.add_argument('-num2', required=False, type=float, default=2)

    tasks_path = ['test_addition.py', 'test_subtraction.py', 'test_multiplication.py', 'test_division.py']
